...
class AppoinmentsView : UIView, UIScrollViewDelegate {
    ...
    private func setupUI () {
        ...
        self.view3.addSubview(self.settingView(clockText: "05:00 PM", dateText: "07", dayText: "Sat", name: "Dr. Taylor Anne", problem: "Coldness", mainColor: "#A523BB", color: "#AC50E1"))
    ...
    @objc func onPageControlChange (_ sender: UIPageControl ) {
        self.scrollView.setContentOffset(CGPoint(x: (sender.currentPage) * Int(UIScreen.main.bounds.width), y: 0), animated: true)
    }
}
